...
Connection conexao = null;
    ...
    /**
     * Creates new form PesquisaVendedor
     */
    ...
    private void pesquisarProfissao(){
           String sql = "select idVendedor as Codigo, "
                   ...
                   + "from vendedor where Nome_Vendedor like";
        try {
    ...
    private void carregarCampos(){
       ...
       txtNome.setText(tblPesquisar.getModel().getValueAt(carga, 1).toString());    
       Desabilitar();
    ...
    private void tblPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPesquisarMouseClicked
        ...
        passarcodigo = txtCodigo.getText();
        passardescri = txtNome.getText();   
    ...
    public void setVisible(Object object, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
